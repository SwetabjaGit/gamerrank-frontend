...
import SuccessSnackbar from '../../components/SnackbarAlert';
...
const GeneralSettings = props => {
  ...
  const [snackMessage, setSnackMessage] = useState('Default');
  ...
  const handleChange = event => {
    ...
    if(event.target.checked === true) {
      setSnackType('error');
      setSnackMessage('Contact info is Public');
    } else {
      setSnackType('warning');
      setSnackMessage('Contact info is Private');
    }
  ...
  const handleSubmit = event => {
    ...
    setSnackMessage('Successfully saved changes!');
    setOpenSnackbar(true);
  };
