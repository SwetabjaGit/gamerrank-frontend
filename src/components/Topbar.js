...
import { logoutUser, getUserData, fetchNotifications } from '../redux/actions/user';
...
const Navbar = (props) => {
  ...
  const signupIcon = (
    <NavbarButton key="Signup" tip="Signup" link="/auth/signup" btnClassName={classes.notificationsButton}>
      <PersonAddIcon />
    </NavbarButton>
  );

  const loginIcon = (
    <NavbarButton key="Login" tip="Login" link="/auth/loginold" btnClassName={classes.notificationsButton}>
      <LockOpenIcon />
    </NavbarButton>
  );
  ...
  const homeIcon = (
    <NavbarButton key="Home" tip="Home" link="/home" btnClassName={classes.notificationsButton}>
      <HomeIcon />
    </NavbarButton>
  );
