...
var styles = function styles(theme) {
  ...
  return {
    ...
    standardSuccess: {
      color: getColor('#4CAF50', 0.6),
      backgroundColor: getBackgroundColor('#4CAF50', 0.9),
      '& $icon': {
        color: '#4CAF50'
      }
    },
    ...
    standardInfo: {
      color: getColor('#2196F3', 0.6),
      backgroundColor: getBackgroundColor('#2196F3', 0.9),
      '& $icon': {
        color: '#2196F3'
      }
    },
    ...
    standardWarning: {
      color: getColor('#FB9701', 0.6),
      backgroundColor: getBackgroundColor('#FB9701', 0.9),
      '& $icon': {
        color: '#FB9701'
      }
    },
    ...
    standardError: {
      color: getColor('#F44336', 0.6),
      backgroundColor: getBackgroundColor('#F44336', 0.9),
      '& $icon': {
        color: '#F44336'
      }
    },
    ...
    outlinedSuccess: {
      color: getColor('#4CAF50', 0.6),
      border: "1px solid ".concat('#4CAF50'),
      '& $icon': {
        color: '#4CAF50'
      }
    },
    ...
    outlinedInfo: {
      color: getColor('#2196F3', 0.6),
      border: "1px solid ".concat('#2196F3'),
      '& $icon': {
        color: '#2196F3'
      }
    },
    ...
    outlinedWarning: {
      color: getColor('#FB9701', 0.6),
      border: "1px solid ".concat('#FB9701'),
      '& $icon': {
        color: '#FB9701'
      }
    },
    ...
    outlinedError: {
      color: getColor('#F44336', 0.6),
      border: "1px solid ".concat('#F44336'),
      '& $icon': {
        color: '#F44336'
      }
    },
